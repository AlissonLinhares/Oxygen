...
var AvlTree = function(opt_comparator) {
  this.comparator_ = opt_comparator || AvlTree.DEFAULT_COMPARATOR_;
};
...
AvlTree.prototype.inOrderTraverse =
  ...
  var startNode = this.getMinNode_();
...
AvlTree.prototype.reverseOrderTraverse =
  ...
  var startNode = this.getMaxNode_();
 ...
 * @param {AvlTree.Node.<T>=} opt_startNode The node at which the
 *     traversal begins.
 * @param {AvlTree.Node.<T>=} opt_endNode The node at which the
 *     traversal ends.
 */
 ...
 * added or removed).
 *
 * @param {AvlTree.Node.<T>} node Node to begin balance from.
 */
 ...
 *
 * @param {AvlTree.Node.<T>} node Pivot node to rotate from.
 */
 ...
 *
 * @param {AvlTree.Node.<T>} node The node to be removed.
 */
 ...
 * @param {AvlTree.Node.<T>=} opt_rootNode Optional root node.
 * @return {AvlTree.Node.<T>} The node at the specified index.
 */
 ...
 *
 * @param {AvlTree.Node.<T>=} opt_rootNode Optional root node.
 * @return {AvlTree.Node.<T>} The node with the smallest value in
 *     the tree.
 */
 ...
 *
 * @param {AvlTree.Node.<T>=} opt_rootNode Optional root node.
 * @return {AvlTree.Node.<T>} The node with the largest value in
 *     the tree.
 */
 ...
 * @param {AvlTree.Node.<T>=} opt_parent Optional parent node.
 * @constructor
 * @template T
 */
